  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        <section className="glow">
          <div className="mx-auto max-w-3xl px-5 pb-12 pt-16 text-center sm:pt-24">
            ...
            <h1 className="display mx-auto mt-5 max-w-2xl text-5xl text-cream sm:text-6xl">
              Lives changed by
              <span className="text-gold"> the Word.</span>
            </h1>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-muted">
              Examine is brand new, so rather than invent testimonials, we begin with the
            ...
            {WITNESSES.map((w) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="flex h-10 w-10 items-center justify-center rounded-full border border-gold/30 bg-ink-2 text-gold">
                ...
                <a
                  ...
                  className="mt-4 inline-block text-sm font-medium text-gold transition hover:text-gold-soft hover:underline"
                >
                  {w.reference} ↗
                </a>
              </article>
        ...
        {/* Your turn — invite for real testimonies */}
        <section className="border-t border-line bg-ink-2/40">
          <div className="mx-auto max-w-3xl px-5 py-20 text-center">
            <h2 className="display text-3xl text-cream sm:text-4xl">Your story belongs here</h2>
            ...
            <a
              href="mailto:hello@examine-bible.app?subject=My%20testimony"
              className="mt-8 inline-block rounded-xl bg-gold px-7 py-3.5 font-semibold text-ink transition hover:bg-gold-soft"
            >
              Share your story
            </a>
            <p className="mt-10 text-sm text-muted">
              Or go and see for yourself —{" "}
              <Link href="/" className="font-medium text-gold hover:text-gold-soft hover:underline">
                examine the Word
              </Link>
              .
            </p>
