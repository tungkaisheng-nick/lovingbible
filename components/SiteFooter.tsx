...
export default function SiteFooter() {
  return (
    <footer className="band border-t border-band-line">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-4 px-5 py-12 text-center text-sm text-band-muted">
        ...
        <p className="text-xs text-band-muted/60">© 2026 LovingBible</p>
      </div>
    </footer>
  );
}
